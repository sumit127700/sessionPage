    ...
    <nav style={styles.navbar}>
      ...
      <div style={styles.icons}>
        <button style={styles.iconButton}>
          ...
          >
            <rect width="30" height="30" fill="url(#pattern0_39_39)" />
            <defs>
              <pattern
                id="pattern0_39_39"
